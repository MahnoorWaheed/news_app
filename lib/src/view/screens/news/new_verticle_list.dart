...
class NewsVerticleList extends StatefulWidget {
  const NewsVerticleList({super.key});

  @override
  State<NewsVerticleList> createState() => _NewsVerticleListState();
}

class _NewsVerticleListState extends State<NewsVerticleList> {
  Future? newsFuture;
  @override
  void initState() {
