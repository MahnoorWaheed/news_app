...
class ElectronicVerticleView extends StatefulWidget {
  const ElectronicVerticleView({super.key});

  @override
  State<ElectronicVerticleView> createState() => _ElectronicVerticleViewState();
}

class _ElectronicVerticleViewState extends State<ElectronicVerticleView> {
  Future? newsFuture;
  @override
  void initState() {
    // TODO: implement initState
    newsFuture = getElectronicCircuits();
    super.initState();
  }
  @override
    ...
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child:  FutureBuilder<List<ElectronicCircuitModel>>(
