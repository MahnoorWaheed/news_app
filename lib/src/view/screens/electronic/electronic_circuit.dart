...
import 'package:news_app/src/view/screens/electronic/electronic_cverticle.dart';
import 'package:news_app/src/view/screens/electronic/electronic_details.dart';
...
FutureBuilder<List<ElectronicCircuitModel>> electronicCircuitOption(List<dynamic> _searchResults, bool onsubmit) {
    return FutureBuilder<List<ElectronicCircuitModel>>(
                                future: getElectronicCircuits(),
                      ...
                      return Column(
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              largeText("Electronic Circuits"),
                              Row(
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=>ElectronicVerticleView()));
                                    },
                                              ...
                                              GestureDetector(
                                                onTap: (){
                                                  Navigator.of(context).push(MaterialPageRoute(
                                                    builder: ((context) => ElectronicDetails(id: i))));
                                                },
                                                child: Column(
                                                  children: [
                                                    ...
                                                    child: 
                                                     ...
                                                     ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        _searchResults[i]["field_image"].replaceAll("/circuitdigest_9/sites/",
                          ...
                          largeText("All Electronic Circuits"),
                          const SizedBox(height: 10),
                          reuableContainer(context,
                         ...
                         const SizedBox(height: 20),
                           Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> const ElectronicVerticleView()));
                                },
                                child: Row(
                                  children: [
                                    smallText("read more"),
