...
class _DashboardState extends State<Dashboard> {
                      ...
                      return Consumer<LoadingProvider>(
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  reuableContainer(context,
                                      wtd: 40,
                                      clr: value.isNews == false &&
                                              value.isINTERVIEW == false &&
                                              value.isPRODUCT == false
                                          ? AppColor.lightBlue
                                          : AppColor.lightgrey, onTap: () {
                                  ...
                                  reuableContainer(
                                    context,
                                    wtd: MediaQuery.of(context).size.width *
                                        0.15,
                                    clr: value.isNews == false &&
                                            value.isINTERVIEW == false &&
                            ...
                            value.isINTERVIEW
                                ? FutureBuilder<List<Cicuitdigest>>(builder:(context, snapdata)=> interviewSection(context, value, snapshot))
  ...
  Container interviewSection(BuildContext context, LoadingProvider value,
      AsyncSnapshot<List<Cicuitdigest>> snapshot) {
    return Container(
      child: Column(
        children: [
                        ...
                        ? Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  return Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: snapshot.data![i].fieldTags!
                                                  .contains("Interview") ==
                                              true
                                          ? GestureDetector(
                                              onTap: () {
                                  ...
                                  return Padding(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Column(
                                          children: [
                                            reuableContainer(context,
                                                hgt: MediaQuery.of(context)
                                                        .size
                                                        .height *
                                                    0.2,
                                                wtd: MediaQuery.of(context)
                                                        .size
                                                        .width *
                                                    0.6,
                                                child: ClipRRect(
          ...
          reuableContainer(context,
              ...
              child: ClipRRect(
                child: Image.network(
                  snapshot.data![0].fieldImage!.replaceAll(
                      "/circuitdigest_9/sites/",
                      "https://circuitdigest.com/sites/"),
                  fit: BoxFit.cover,
                ),
          ...
          const SizedBox(height: 10),
          smallText(snapshot.data![0].body!, clr: AppColor.darkBlue, max: 2),
  ...
  Container newsSection(BuildContext context, LoadingProvider value,
      AsyncSnapshot<List<Cicuitdigest>> snapshot) {
    return Container(
      child: Column(
        children: [
