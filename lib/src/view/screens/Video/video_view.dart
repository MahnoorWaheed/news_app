...
FutureBuilder<List<VideoModel>> videoOption(List<dynamic> _searchResults, bool onsubmit ) {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=>VideoVerticle()));
                                    },
                                              ...
                                              GestureDetector(
                                                onTap: (){
                                                  Navigator.of(context).push(MaterialPageRoute(
                                                    builder: ((context) => VideoDetails(id: i))));
                                                },
                                                child: Column(
                                                  children: [
                         ...
                         const SizedBox(height: 20),
                           Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> const VideoVerticle()));
                                },
                                child: Row(
                                  children: [
                                    smallText("read more"),
