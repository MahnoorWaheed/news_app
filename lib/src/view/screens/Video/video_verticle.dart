...
class VideoVerticle extends StatefulWidget {
  const VideoVerticle({super.key});

  @override
  State<VideoVerticle> createState() => _VideoVerticleState();
}

class _VideoVerticleState extends State<VideoVerticle> {
  Future? newsFuture;
  @override
  void initState() {
