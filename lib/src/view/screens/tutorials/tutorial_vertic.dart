...
class TutorialVerticle extends StatefulWidget {
  const TutorialVerticle({super.key});

  @override
  State<TutorialVerticle> createState() => _TutorialVerticleState();
}

class _TutorialVerticleState extends State<TutorialVerticle> {
  Future? newsFuture;
  @override
  void initState() {
    // TODO: implement initState
    newsFuture = getTutorial();
    super.initState();
  }
  @override
