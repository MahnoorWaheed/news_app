...
class MicroDetails extends StatefulWidget {
  int id;
   MicroDetails({super.key, required this.id});

  @override
  State<MicroDetails> createState() => _MicroDetailsState();
}

class _MicroDetailsState extends State<MicroDetails> {
 Future? newsFuture;
  NewsModel? newsModel;
