...
class MicroVerticleList extends StatefulWidget {
  const MicroVerticleList({super.key});

  @override
  State<MicroVerticleList> createState() => _MicroVerticleListState();
}

class _MicroVerticleListState extends State<MicroVerticleList> {
  Future? newsFuture;
  @override
  void initState() {
    // TODO: implement initState
    newsFuture = getMicroControllers();
    super.initState();
  }
  @override
    ...
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child:  FutureBuilder<List<MicroControllerModel>>(
