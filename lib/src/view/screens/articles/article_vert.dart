...
class ArticleVerticle extends StatefulWidget {
  const ArticleVerticle({super.key});

  @override
  State<ArticleVerticle> createState() => _ArticleVerticleState();
}

class _ArticleVerticleState extends State<ArticleVerticle> {
  Future? newsFuture;
  @override
  void initState() {
    // TODO: implement initState
    newsFuture = getArticles();
    super.initState();
  }
  @override
